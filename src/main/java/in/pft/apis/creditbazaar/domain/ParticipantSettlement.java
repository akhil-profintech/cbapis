...
public class ParticipantSettlement implements Serializable {
    ...
    public void setDocDetails(Set<DocDetails> docDetails) {
        if (this.docDetails != null) {
            this.docDetails.forEach(i -> i.setParticipantsettlement(null));
        }
        if (docDetails != null) {
            docDetails.forEach(i -> i.setParticipantsettlement(this));
        }
        this.docDetails = docDetails;
    }

    public ParticipantSettlement docDetails(Set<DocDetails> docDetails) {
        this.setDocDetails(docDetails);
        return this;
    }

    public ParticipantSettlement addDocDetails(DocDetails docDetails) {
        this.docDetails.add(docDetails);
        docDetails.setParticipantsettlement(this);
        return this;
    }

    public ParticipantSettlement removeDocDetails(DocDetails docDetails) {
        this.docDetails.remove(docDetails);
        docDetails.setParticipantsettlement(null);
        return this;
    }
