...
public class UserDtls implements Serializable {
    ...
    @Transient
    @JsonIgnoreProperties(value = { "userDtls", "tradePartners", "anchorTraders", "financePartners" }, allowSetters = true)
    ...
    public UserDtls userId(String userId) {
    ...
    public UserDtls organization(Organization organization) {
