...
public class CBCREProcessSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("anchort_trader_gst", table, columnPrefix + "_anchort_trader_gst"));
        ...
        columns.add(Column.aliased("cumilativetradescore", table, columnPrefix + "_cumilativetradescore"));
