...
public class TradeRowMapper implements BiFunction<Row, String, Trade> {
    ...
    public Trade apply(Row row, String prefix) {
        ...
        entity.setTradeId(converter.fromRow(row, prefix + "_trade_id", Long.class));
        entity.setTradeRefNumber(converter.fromRow(row, prefix + "_trade_ref_number", String.class));
