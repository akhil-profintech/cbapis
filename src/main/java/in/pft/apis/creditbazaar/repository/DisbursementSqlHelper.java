...
public class DisbursementSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("accepted_offer_id", table, columnPrefix + "_accepted_offer_id"));
        ...
        columns.add(Column.aliased("dbmtstatus", table, columnPrefix + "_dbmtstatus"));
        ...
        columns.add(Column.aliased("collection_trnx_details_id", table, columnPrefix + "_collection_trnx_details_id"));
