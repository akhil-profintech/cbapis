...
public class TradeChannelCustomRepoImpl implements TradeChannelCustomRepo
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<TradeChannel> findAllByFilter(String filter, Pageable pageable) {
