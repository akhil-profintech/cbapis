...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.Settlement}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<SettlementDTO>>> getAllSettlements(
        ...
        return settlementService
            ...
            return settlementService
                ...
                .zipWith(settlementService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
