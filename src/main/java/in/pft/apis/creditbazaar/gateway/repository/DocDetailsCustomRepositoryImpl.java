...
public class DocDetailsCustomRepositoryImpl implements DocDetailsCustomRepository
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<DocDetails> findAllByFilter(String filter, Pageable pageable) {
