...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.RequestOffer}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<RequestOfferDTO>>> getAllRequestOffers(
        ...
        return requestOfferService
            ...
            return requestOfferService
                ...
                .zipWith(requestOfferService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
