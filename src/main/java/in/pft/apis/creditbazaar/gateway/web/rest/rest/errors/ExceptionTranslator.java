...
import in.pft.apis.creditbazaar.gateway.web.rest.errors.FieldErrorVM;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof in.pft.apis.creditbazaar.gateway.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (
            ex instanceof in.pft.apis.creditbazaar.gateway.service.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof in.pft.apis.creditbazaar.gateway.service.InvalidPasswordException
    ...
    private List<in.pft.apis.creditbazaar.gateway.web.rest.errors.FieldErrorVM> getFieldErrors(WebExchangeBindException ex) {
        return ex
            .getBindingResult()
            .getFieldErrors()
            .stream()
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "in.pft.apis.creditbazaar.gateway"
        );
    }
}
