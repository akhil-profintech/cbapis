...
public class AcceptedOfferCustomRepositoryImpl implements AcceptedOfferCustomRepository
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<AcceptedOffer> findAllByFilter(String filter,Pageable pageable) {
