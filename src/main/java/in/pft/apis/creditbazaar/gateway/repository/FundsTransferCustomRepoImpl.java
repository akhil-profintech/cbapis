...
public class FundsTransferCustomRepoImpl implements FundsTransferCustomRepo
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<FundsTransfer> findAllByFilter(String filter, Pageable pageable) {
