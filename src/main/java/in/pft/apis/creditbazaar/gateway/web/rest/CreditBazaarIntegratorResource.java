...
import in.pft.apis.creditbazaar.gateway.service.CreditBazaarIntegratorService;
...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.CreditBazaarIntegrator}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<CreditBazaarIntegratorDTO>>> getAllCreditBazaarIntegrators(
        ...
        return creditBazaarIntegratorService
            ...
            return creditBazaarIntegratorService
                ...
                .zipWith(creditBazaarIntegratorService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
