...
public class EscrowTransactionDetailsSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("id", table, columnPrefix + "_id"));
        columns.add(Column.aliased("escrow_trnx_details_id", table, columnPrefix + "_escrow_trnx_details_id"));
        columns.add(Column.aliased("escrow_trnx_details_ulid_id", table, columnPrefix + "_escrow_trnx_details_ulid_id"));
