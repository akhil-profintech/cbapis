...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.AcceptedOffer}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<AcceptedOfferDTO>>> getAllAcceptedOffers(
        ...
        return acceptedOfferService
            ...
            return acceptedOfferService
                ...
                .zipWith(acceptedOfferService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
