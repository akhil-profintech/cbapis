...
/**
 * Service Implementation for managing {@link in.pft.apis.creditbazaar.gateway.domain.InstaAlert}.
 */
@Service
@Transactional
public class InstaAlertService {
    ...
    public Mono<InstaAlertDTO> save(InstaAlertDTO instaAlertDTO) {
        ...
        instaAlertDTO.setInstaAlertId(IdAndUlidGeneration.generateUniqueLong(9));
