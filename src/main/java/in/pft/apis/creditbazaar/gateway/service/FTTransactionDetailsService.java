...
/**
 * Service Implementation for managing {@link in.pft.apis.creditbazaar.gateway.domain.FTTransactionDetails}.
 */
@Service
@Transactional
public class FTTransactionDetailsService {
    ...
    public Mono<FTTransactionDetailsDTO> save(FTTransactionDetailsDTO fTTransactionDetailsDTO) {
        ...
        fTTransactionDetailsDTO.setFtTrnxDetailsId(IdAndUlidGeneration.generateUniqueLong(9));
        fTTransactionDetailsDTO.setFtTrnxDetailsUlid(IdAndUlidGeneration.generateUlid());
