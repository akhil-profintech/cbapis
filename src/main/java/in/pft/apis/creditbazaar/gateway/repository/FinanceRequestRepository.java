...
@Repository
public interface FinanceRequestRepository extends ReactiveCrudRepository<FinanceRequest, Long>, FinanceRequestRepositoryInternal ,FinanceRequestCustomRepository{
