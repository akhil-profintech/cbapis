...
public class CREHighlightsCustomRepoImpl implements CREHighlightsCustomRepo
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;

    @Override
    public Flux<CREHighlights> findAllByFilter(String filter, Pageable pageable) {
