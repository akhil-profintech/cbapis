...
import in.pft.apis.creditbazaar.gateway.service.AnchorTraderService;
...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.AnchorTrader}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<AnchorTraderDTO>>> getAllAnchorTraders(
        ...
        return anchorTraderService
            ...
            return anchorTraderService
                ...
                .zipWith(anchorTraderService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
