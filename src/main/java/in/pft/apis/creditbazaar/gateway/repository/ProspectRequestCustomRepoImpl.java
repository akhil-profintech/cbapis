...
public class ProspectRequestCustomRepoImpl implements ProspectRequestCustomRepo
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<ProspectRequest> findAllByFilter(String filter, Pageable pageable) {
