...
public class CREObservationsCustomRepoImpl implements CREObservationsCustomRepo
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;

    @Override
    public Flux<CREObservations> findAllByFilter(String filter, Pageable pageable) {
