...
public class TradeEntityCustomRepoImpl implements TradeEntityCustomRepo
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;

    @Override
    public Flux<TradeEntity> findAllByFilter(String filter, Pageable pageable) {
