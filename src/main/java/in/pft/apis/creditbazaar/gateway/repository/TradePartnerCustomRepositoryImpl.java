...
public class TradePartnerCustomRepositoryImpl implements TradePartnerCustomRepository
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<TradePartner> findAllByFilter(String filter, Pageable pageable) {
