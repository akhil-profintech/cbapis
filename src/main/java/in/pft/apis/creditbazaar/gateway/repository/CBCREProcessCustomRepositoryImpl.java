...
public class CBCREProcessCustomRepositoryImpl implements CBCREProcessCustomRepository
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<CBCREProcess> findAllByFilter(String filter, Pageable pageable) {
