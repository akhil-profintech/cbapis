...
import in.pft.apis.creditbazaar.gateway.service.ProspectRequestService;
...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.ProspectRequest}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<ProspectRequestDTO>>> getAllProspectRequests(
        ...
        return prospectRequestService
            ...
            return prospectRequestService
                ...
                .zipWith(prospectRequestService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
