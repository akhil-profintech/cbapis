...
/**
 * Service Implementation for managing {@link in.pft.apis.creditbazaar.gateway.domain.CreditBazaarIntegrator}.
 */
@Service
@Transactional
public class CreditBazaarIntegratorService {
    ...
    public Mono<CreditBazaarIntegratorDTO> save(CreditBazaarIntegratorDTO creditBazaarIntegratorDTO) {
        ...
        creditBazaarIntegratorDTO.setIntegratorUlidId(IdAndUlidGeneration.generateUlid());
