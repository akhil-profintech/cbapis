...
public class Trade implements Serializable {
    ...
    public String getTradeUlidId() {
        return this.tradeUlidId;
    }

    public Trade tradeUlidId(String tradeUlidId) {
        this.setTradeUlidId(tradeUlidId);
        return this;
    }
    ...
    public Trade tradeRefNo(String tradeRefNo) {
        this.setTradeRefNo(tradeRefNo);
        return this;
    }
