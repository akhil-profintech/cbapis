...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.CreditAccountDetails}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<CreditAccountDetailsDTO>>> getAllCreditAccountDetails(
        ...
        return creditAccountDetailsService
            ...
            return creditAccountDetailsService
                ...
                .zipWith(creditAccountDetailsService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
