...
public class AnchorTraderCustomRepositoryImpl implements AnchorTraderCustomRepository
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;

    @Override
    public Flux<AnchorTrader> findAllByFilter(String filter, Pageable pageable) {
