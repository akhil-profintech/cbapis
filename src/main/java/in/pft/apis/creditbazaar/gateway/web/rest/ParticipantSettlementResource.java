...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.gateway.domain.ParticipantSettlement}.
 */
@RestController
    ...
    public Mono<ResponseEntity<List<ParticipantSettlementDTO>>> getAllParticipantSettlements(
        ...
        return participantSettlementService
            ...
            return participantSettlementService
                ...
                .zipWith(participantSettlementService.findAllByFilter(filter, pageable).collectList())
                .map(countWithEntities ->
                    ResponseEntity
                        .ok()
                        .headers(
