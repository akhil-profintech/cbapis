...
/**
 * Service Implementation for managing {@link in.pft.apis.creditbazaar.gateway.domain.TradeEntity}.
 */
@Service
@Transactional
public class TradeEntityService {
    ...
    public Mono<TradeEntityDTO> save(TradeEntityDTO tradeEntityDTO) {
        ...
        tradeEntityDTO.setEntityId(IdAndUlidGeneration.generateUniqueLong(9));
        tradeEntityDTO.setEntityUlidId(IdAndUlidGeneration.generateUlid());
