...
public class DisbursementCustomRepositoryImpl implements DisbursementCustomRepository
{
    private final R2dbcEntityTemplate r2dbcEntityTemplate;
    @Override
    public Flux<Disbursement> findAllByFilter(String filter, Pageable pageable) {
