...
/**
 * Service Implementation for managing {@link in.pft.apis.creditbazaar.gateway.domain.BeneValidation}.
 */
@Service
@Transactional
public class BeneValidationService {
    ...
    public Mono<BeneValidationDTO> save(BeneValidationDTO beneValidationDTO) {
        ...
        beneValidationDTO.setBenevalidationId(IdAndUlidGeneration.generateUlid());
