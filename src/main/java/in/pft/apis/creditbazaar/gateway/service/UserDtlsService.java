...
/**
 * Service Implementation for managing {@link in.pft.apis.creditbazaar.gateway.domain.UserDtls}.
 */
@Service
@Transactional
public class UserDtlsService {
    ...
    public Mono<UserDtlsDTO> save(UserDtlsDTO userDtlsDTO) {
        ...
        userDtlsDTO.setUserUlidId(IdAndUlidGeneration.generateUlid());
    ...
    public Mono<UserDtlsDTO> findOne(Long id) {
        ...
        return userDtlsRepository.findById(id).map(userDtlsMapper::toDto);
    }
