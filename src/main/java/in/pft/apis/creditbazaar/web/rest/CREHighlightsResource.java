...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.domain.CREHighlights}.
 */
@RestController
...
public class CREHighlightsResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<CREHighlightsDTO>> createCREHighlights(@Valid @RequestBody CREHighlightsDTO cREHighlightsDTO)
    ...
    public Mono<ResponseEntity<CREHighlightsDTO>> updateCREHighlights(
        ...
        @Valid @RequestBody CREHighlightsDTO cREHighlightsDTO
    ) throws URISyntaxException {
    ...
    public Mono<ResponseEntity<CREHighlightsDTO>> partialUpdateCREHighlights(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody CREHighlightsDTO cREHighlightsDTO
    ) throws URISyntaxException {
