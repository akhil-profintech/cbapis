...
/**
 * REST controller for managing {@link in.pft.apis.creditbazaar.domain.CREObservations}.
 */
@RestController
...
public class CREObservationsResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<CREObservationsDTO>> createCREObservations(@Valid @RequestBody CREObservationsDTO cREObservationsDTO)
    ...
    public Mono<ResponseEntity<CREObservationsDTO>> updateCREObservations(
        ...
        @Valid @RequestBody CREObservationsDTO cREObservationsDTO
    ) throws URISyntaxException {
    ...
    public Mono<ResponseEntity<CREObservationsDTO>> partialUpdateCREObservations(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody CREObservationsDTO cREObservationsDTO
    ) throws URISyntaxException {
