...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../trade.test-samples';

import { TradeService, RestTrade } from './trade.service';
