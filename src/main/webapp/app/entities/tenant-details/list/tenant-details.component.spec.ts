...
describe('TenantDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'tenant-details', component: TenantDetailsComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tenantDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tenantDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTenantDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTenantDetailsIdentifier).toHaveBeenCalledWith(entity);
