...
describe('Context Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'context', component: ContextComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to contextService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContextIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContextIdentifier).toHaveBeenCalledWith(entity);
