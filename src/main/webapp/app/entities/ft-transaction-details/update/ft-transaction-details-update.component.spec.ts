...
describe('FTTransactionDetails Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Disbursement query and add missing value', () => {
      ...
      const disbursement: IDisbursement = { id: 14293 };
      fTTransactionDetails.disbursement = disbursement;

      const disbursementCollection: IDisbursement[] = [{ id: 4880 }];
    ...
    it('Should call Repayment query and add missing value', () => {
      const fTTransactionDetails: IFTTransactionDetails = { id: 456 };
      const repayment: IRepayment = { id: 18183 };
      fTTransactionDetails.repayment = repayment;

      const repaymentCollection: IRepayment[] = [{ id: 16198 }];
    ...
    it('Should call ParticipantSettlement query and add missing value', () => {
      const fTTransactionDetails: IFTTransactionDetails = { id: 456 };
      const participantsettlement: IParticipantSettlement = { id: 24899 };
      fTTransactionDetails.participantsettlement = participantsettlement;

      const participantSettlementCollection: IParticipantSettlement[] = [{ id: 18947 }];
    ...
    it('Should update editForm', () => {
      const fTTransactionDetails: IFTTransactionDetails = { id: 456 };
      const disbursement: IDisbursement = { id: 14992 };
      fTTransactionDetails.disbursement = disbursement;
      const repayment: IRepayment = { id: 28340 };
      fTTransactionDetails.repayment = repayment;
      const participantsettlement: IParticipantSettlement = { id: 11402 };
      fTTransactionDetails.participantsettlement = participantsettlement;
