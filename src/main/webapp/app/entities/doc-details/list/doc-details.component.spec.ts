...
describe('DocDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'doc-details', component: DocDetailsComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.docDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to docDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDocDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDocDetailsIdentifier).toHaveBeenCalledWith(entity);
