...
describe('Disbursement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'disbursement', component: DisbursementComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.disbursements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to disbursementService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDisbursementIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDisbursementIdentifier).toHaveBeenCalledWith(entity);
