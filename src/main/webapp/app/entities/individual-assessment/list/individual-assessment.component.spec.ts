...
describe('IndividualAssessment Management Component', () => {
  let comp: IndividualAssessmentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'individual-assessment', component: IndividualAssessmentComponent }]),
      ...
      .overrideTemplate(IndividualAssessmentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.individualAssessments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to individualAssessmentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIndividualAssessmentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIndividualAssessmentIdentifier).toHaveBeenCalledWith(entity);
