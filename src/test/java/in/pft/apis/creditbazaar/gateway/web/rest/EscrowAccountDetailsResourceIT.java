...
class EscrowAccountDetailsResourceIT {
    ...
    private static final String DEFAULT_ESCROW_DETAILS_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_ESCROW_DETAILS_ULID_ID = "BBBBBBBBBB";
    ...
    public static EscrowAccountDetails createEntity(EntityManager em) {
        EscrowAccountDetails escrowAccountDetails = new EscrowAccountDetails()
            ...
            .escrowDetailsUlidId(DEFAULT_ESCROW_DETAILS_ULID_ID)
    ...
    public static EscrowAccountDetails createUpdatedEntity(EntityManager em) {
        EscrowAccountDetails escrowAccountDetails = new EscrowAccountDetails()
            ...
            .escrowDetailsUlidId(UPDATED_ESCROW_DETAILS_ULID_ID)
    ...
    void createEscrowAccountDetails() throws Exception {
        ...
        assertThat(testEscrowAccountDetails.getEscrowDetailsUlidId()).isEqualTo(DEFAULT_ESCROW_DETAILS_ULID_ID);
    ...
    void getAllEscrowAccountDetails() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].escrowDetailsUlidId")
            .value(hasItem(DEFAULT_ESCROW_DETAILS_ULID_ID))
            .jsonPath("$.[*].tenantId")
    ...
    void getEscrowAccountDetails() {
        ...
        webTestClient
            ...
            .jsonPath("$.escrowDetailsUlidId")
            .value(is(DEFAULT_ESCROW_DETAILS_ULID_ID))
            .jsonPath("$.tenantId")
    ...
    void putExistingEscrowAccountDetails() throws Exception {
        ...
        assertThat(testEscrowAccountDetails.getEscrowDetailsUlidId()).isEqualTo(UPDATED_ESCROW_DETAILS_ULID_ID);
