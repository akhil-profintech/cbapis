...
class ProspectRequestResourceIT {
    ...
    private static final String DEFAULT_PROSPECT_REQUEST_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_PROSPECT_REQUEST_ULID_ID = "BBBBBBBBBB";
    ...
    public static ProspectRequest createEntity(EntityManager em) {
        ProspectRequest prospectRequest = new ProspectRequest()
            ...
            .prospectRequestUlidId(DEFAULT_PROSPECT_REQUEST_ULID_ID)
    ...
    public static ProspectRequest createUpdatedEntity(EntityManager em) {
        ProspectRequest prospectRequest = new ProspectRequest()
            ...
            .prospectRequestUlidId(UPDATED_PROSPECT_REQUEST_ULID_ID)
    ...
    void createProspectRequest() throws Exception {
        ...
        assertThat(testProspectRequest.getProspectRequestUlidId()).isEqualTo(DEFAULT_PROSPECT_REQUEST_ULID_ID);
    ...
    void getAllProspectRequests() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].prospectRequestUlidId")
            .value(hasItem(DEFAULT_PROSPECT_REQUEST_ULID_ID))
    ...
    void getProspectRequest() {
        ...
        webTestClient
            ...
            .jsonPath("$.prospectRequestUlidId")
            .value(is(DEFAULT_PROSPECT_REQUEST_ULID_ID))
            .jsonPath("$.anchorTraderId")
    ...
    void putExistingProspectRequest() throws Exception {
        ...
        assertThat(testProspectRequest.getProspectRequestUlidId()).isEqualTo(UPDATED_PROSPECT_REQUEST_ULID_ID);
