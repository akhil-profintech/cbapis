...
class TenantDetailsResourceIT {
    ...
    private static final String DEFAULT_TENANT_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_TENANT_ULID_ID = "BBBBBBBBBB";
    ...
    public static TenantDetails createEntity(EntityManager em) {
        TenantDetails tenantDetails = new TenantDetails().tenantUlidId(DEFAULT_TENANT_ULID_ID).tenantSchema(DEFAULT_TENANT_SCHEMA);
    ...
    public static TenantDetails createUpdatedEntity(EntityManager em) {
        TenantDetails tenantDetails = new TenantDetails().tenantUlidId(UPDATED_TENANT_ULID_ID).tenantSchema(UPDATED_TENANT_SCHEMA);
        return tenantDetails;
    }
    ...
    void createTenantDetails() throws Exception {
        ...
        assertThat(testTenantDetails.getTenantUlidId()).isEqualTo(DEFAULT_TENANT_ULID_ID);
    ...
    void getAllTenantDetails() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].tenantUlidId")
            .value(hasItem(DEFAULT_TENANT_ULID_ID))
    ...
    void getTenantDetails() {
        ...
        webTestClient
            ...
            .jsonPath("$.tenantUlidId")
            .value(is(DEFAULT_TENANT_ULID_ID))
            .jsonPath("$.tenantSchema")
    ...
    void putExistingTenantDetails() throws Exception {
        ...
        updatedTenantDetails.tenantUlidId(UPDATED_TENANT_ULID_ID).tenantSchema(UPDATED_TENANT_SCHEMA);
        ...
        TenantDetails testTenantDetails = tenantDetailsList.get(tenantDetailsList.size() - 1);
        assertThat(testTenantDetails.getTenantUlidId()).isEqualTo(UPDATED_TENANT_ULID_ID);
    ...
    void fullUpdateTenantDetailsWithPatch() throws Exception {
        ...
        partialUpdatedTenantDetails.tenantUlidId(UPDATED_TENANT_ULID_ID).tenantSchema(UPDATED_TENANT_SCHEMA);
