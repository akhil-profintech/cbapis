...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("in.pft.apis.creditbazaar.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("in.pft.apis.creditbazaar.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
