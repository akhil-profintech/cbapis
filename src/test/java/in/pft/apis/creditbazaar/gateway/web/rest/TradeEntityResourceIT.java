...
import in.pft.apis.creditbazaar.gateway.service.mapper.TradeEntityMapper;
...
class TradeEntityResourceIT {
    ...
    private static final String DEFAULT_ENTITY_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_ENTITY_ULID_ID = "BBBBBBBBBB";
    ...
    public static TradeEntity createEntity(EntityManager em) {
        TradeEntity tradeEntity = new TradeEntity()
            ...
            .entityUlidId(DEFAULT_ENTITY_ULID_ID)
    ...
    public static TradeEntity createUpdatedEntity(EntityManager em) {
        TradeEntity tradeEntity = new TradeEntity()
            ...
            .entityUlidId(UPDATED_ENTITY_ULID_ID)
    ...
    void createTradeEntity() throws Exception {
        ...
        assertThat(testTradeEntity.getEntityUlidId()).isEqualTo(DEFAULT_ENTITY_ULID_ID);
    ...
    void getAllTradeEntities() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].entityUlidId")
            .value(hasItem(DEFAULT_ENTITY_ULID_ID))
            .jsonPath("$.[*].entityName")
    ...
    void getTradeEntity() {
        ...
        webTestClient
            ...
            .jsonPath("$.entityUlidId")
            .value(is(DEFAULT_ENTITY_ULID_ID))
            .jsonPath("$.entityName")
    ...
    void putExistingTradeEntity() throws Exception {
        ...
        assertThat(testTradeEntity.getEntityUlidId()).isEqualTo(UPDATED_ENTITY_ULID_ID);
    ...
    void partialUpdateTradeEntityWithPatch() throws Exception {
        ...
        partialUpdatedTradeEntity.entityId(UPDATED_ENTITY_ID).entityUlidId(UPDATED_ENTITY_ULID_ID).entityGST(UPDATED_ENTITY_GST);
