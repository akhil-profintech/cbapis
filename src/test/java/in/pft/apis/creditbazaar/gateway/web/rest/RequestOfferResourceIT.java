...
import in.pft.apis.creditbazaar.gateway.service.RequestOfferService;
...
class RequestOfferResourceIT {
    ...
    private static final String DEFAULT_REQ_OFFER_REF_NO = "AAAAAAAAAA";
    private static final String UPDATED_REQ_OFFER_REF_NO = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_ANCHOR_TRADER_GSTERP_PEER_SCORE = "AAAAAAAAAA";
    private static final String UPDATED_ANCHOR_TRADER_GSTERP_PEER_SCORE = "BBBBBBBBBB";

    private static final String DEFAULT_SELLER_TRADE_PERFORMANCE_INDEX = "AAAAAAAAAA";
    private static final String UPDATED_SELLER_TRADE_PERFORMANCE_INDEX = "BBBBBBBBBB";
    ...
    public static RequestOffer createEntity(EntityManager em) {
        RequestOffer requestOffer = new RequestOffer()
            ...
            .reqOfferRefNo(DEFAULT_REQ_OFFER_REF_NO)
            ...
            .anchorTraderGSTERPPeerScore(DEFAULT_ANCHOR_TRADER_GSTERP_PEER_SCORE)
            .sellerTradePerformanceIndex(DEFAULT_SELLER_TRADE_PERFORMANCE_INDEX);
        return requestOffer;
    }
    ...
    public static RequestOffer createUpdatedEntity(EntityManager em) {
        RequestOffer requestOffer = new RequestOffer()
            ...
            .reqOfferRefNo(UPDATED_REQ_OFFER_REF_NO)
            ...
            .anchorTraderGSTERPPeerScore(UPDATED_ANCHOR_TRADER_GSTERP_PEER_SCORE)
            .sellerTradePerformanceIndex(UPDATED_SELLER_TRADE_PERFORMANCE_INDEX);
        return requestOffer;
    }
    ...
    void createRequestOffer() throws Exception {
        ...
        assertThat(testRequestOffer.getReqOffUlidId()).isEqualTo(DEFAULT_REQ_OFF_ULID_ID);
        assertThat(testRequestOffer.getReqOfferRefNo()).isEqualTo(DEFAULT_REQ_OFFER_REF_NO);
        ...
        assertThat(testRequestOffer.getAnchorTraderGSTERPPeerScore()).isEqualTo(DEFAULT_ANCHOR_TRADER_GSTERP_PEER_SCORE);
        assertThat(testRequestOffer.getSellerTradePerformanceIndex()).isEqualTo(DEFAULT_SELLER_TRADE_PERFORMANCE_INDEX);
    }
    ...
    void getAllRequestOffers() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].reqOfferRefNo")
            .value(hasItem(DEFAULT_REQ_OFFER_REF_NO))
            .jsonPath("$.[*].offerValue")
            ...
            .jsonPath("$.[*].anchorTraderGSTERPPeerScore")
            .value(hasItem(DEFAULT_ANCHOR_TRADER_GSTERP_PEER_SCORE))
            .jsonPath("$.[*].sellerTradePerformanceIndex")
            .value(hasItem(DEFAULT_SELLER_TRADE_PERFORMANCE_INDEX));
    }
    ...
    void getRequestOffer() {
        ...
        webTestClient
            ...
            .jsonPath("$.reqOfferRefNo")
            .value(is(DEFAULT_REQ_OFFER_REF_NO))
            .jsonPath("$.offerValue")
            ...
            .jsonPath("$.anchorTraderGSTERPPeerScore")
            .value(is(DEFAULT_ANCHOR_TRADER_GSTERP_PEER_SCORE))
            .jsonPath("$.sellerTradePerformanceIndex")
            .value(is(DEFAULT_SELLER_TRADE_PERFORMANCE_INDEX));
    }
    ...
    void putExistingRequestOffer() throws Exception {
        ...
        RequestOffer testRequestOffer = requestOfferList.get(requestOfferList.size() - 1);
        assertThat(testRequestOffer.getReqOffUlidId()).isEqualTo(UPDATED_REQ_OFF_ULID_ID);
        assertThat(testRequestOffer.getReqOfferRefNo()).isEqualTo(UPDATED_REQ_OFFER_REF_NO);
        ...
        assertThat(testRequestOffer.getAnchorTraderGSTERPPeerScore()).isEqualTo(UPDATED_ANCHOR_TRADER_GSTERP_PEER_SCORE);
        assertThat(testRequestOffer.getSellerTradePerformanceIndex()).isEqualTo(UPDATED_SELLER_TRADE_PERFORMANCE_INDEX);
    }
