...
import in.pft.apis.creditbazaar.gateway.repository.UserDtlsRepository;
import in.pft.apis.creditbazaar.gateway.service.dto.UserDtlsDTO;
import in.pft.apis.creditbazaar.gateway.service.mapper.UserDtlsMapper;
...
class UserDtlsResourceIT {
    ...
    private static final String DEFAULT_USER_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_USER_ULID_ID = "BBBBBBBBBB";
    ...
    public static UserDtls createEntity(EntityManager em) {
        UserDtls userDtls = new UserDtls()
            .userUlidId(DEFAULT_USER_ULID_ID)
    ...
    public static UserDtls createUpdatedEntity(EntityManager em) {
        UserDtls userDtls = new UserDtls()
            .userUlidId(UPDATED_USER_ULID_ID)
    ...
    void createUserDtls() throws Exception {
        ...
        assertThat(testUserDtls.getUserUlidId()).isEqualTo(DEFAULT_USER_ULID_ID);
    ...
    void getAllUserDtls() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].userUlidId")
            .value(hasItem(DEFAULT_USER_ULID_ID))
            .jsonPath("$.[*].userName")
    ...
    void putExistingUserDtls() throws Exception {
        ...
        UserDtls testUserDtls = userDtlsList.get(userDtlsList.size() - 1);
        assertThat(testUserDtls.getUserUlidId()).isEqualTo(UPDATED_USER_ULID_ID);
