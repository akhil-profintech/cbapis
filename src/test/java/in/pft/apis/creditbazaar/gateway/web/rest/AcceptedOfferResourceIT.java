...
import in.pft.apis.creditbazaar.gateway.service.AcceptedOfferService;
...
class AcceptedOfferResourceIT {
    ...
    void createAcceptedOffer() throws Exception {
        ...
        assertThat(testAcceptedOffer.getAcceptedOfferUlidId()).isEqualTo(DEFAULT_ACCEPTED_OFFER_ULID_ID);
        assertThat(testAcceptedOffer.getAcceptedOfferRefNo()).isEqualTo(DEFAULT_ACCEPTED_OFFER_REF_NO);
        assertThat(testAcceptedOffer.getReqOffUlidId()).isEqualTo(DEFAULT_REQ_OFF_ULID_ID);
    ...
    void checkReqOffUlidIdIsRequired() throws Exception {
        ...
        // set the field null
        acceptedOffer.setReqOffUlidId(null);
    ...
    void putExistingAcceptedOffer() throws Exception {
        ...
        AcceptedOffer testAcceptedOffer = acceptedOfferList.get(acceptedOfferList.size() - 1);
        assertThat(testAcceptedOffer.getAcceptedOfferUlidId()).isEqualTo(UPDATED_ACCEPTED_OFFER_ULID_ID);
        assertThat(testAcceptedOffer.getAcceptedOfferRefNo()).isEqualTo(UPDATED_ACCEPTED_OFFER_REF_NO);
        assertThat(testAcceptedOffer.getReqOffUlidId()).isEqualTo(UPDATED_REQ_OFF_ULID_ID);
