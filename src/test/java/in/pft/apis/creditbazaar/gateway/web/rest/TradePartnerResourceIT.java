...
class TradePartnerResourceIT {
    ...
    private static final Long DEFAULT_TP_ID = 1L;
    private static final Long UPDATED_TP_ID = 2L;

    private static final String DEFAULT_TP_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_TP_ULID_ID = "BBBBBBBBBB";
    ...
    void createTradePartner() throws Exception {
        ...
        assertThat(testTradePartner.getTpUlidId()).isEqualTo(DEFAULT_TP_ULID_ID);
        ...
        assertThat(testTradePartner.getTradePartnerGST()).isEqualTo(DEFAULT_TRADE_PARTNER_GST);
        ...
        assertThat(testTradePartner.getTosDocument()).isEqualTo(DEFAULT_TOS_DOCUMENT);
    }
    ...
    void getAllTradePartners() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].tpId")
            .value(hasItem(DEFAULT_TP_ID.intValue()))
            .jsonPath("$.[*].tpUlidId")
            .value(hasItem(DEFAULT_TP_ULID_ID))
            .jsonPath("$.[*].orgId")
    ...
    void getTradePartner() {
        ...
        webTestClient
            ...
            .jsonPath("$.tpId")
            .value(is(DEFAULT_TP_ID.intValue()))
            .jsonPath("$.tpUlidId")
            .value(is(DEFAULT_TP_ULID_ID))
            .jsonPath("$.orgId")
    ...
    void putExistingTradePartner() throws Exception {
        ...
        assertThat(testTradePartner.getTpUlidId()).isEqualTo(UPDATED_TP_ULID_ID);
        ...
        assertThat(testTradePartner.getTradePartnerGST()).isEqualTo(UPDATED_TRADE_PARTNER_GST);
        ...
        assertThat(testTradePartner.getTosDocument()).isEqualTo(UPDATED_TOS_DOCUMENT);
    }
