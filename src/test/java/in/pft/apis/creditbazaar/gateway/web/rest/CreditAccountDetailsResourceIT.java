...
import in.pft.apis.creditbazaar.gateway.service.CreditAccountDetailsService;
...
class CreditAccountDetailsResourceIT {
    ...
    private static final String DEFAULT_CREDIT_ACCOUNT_DETAILS_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_CREDIT_ACCOUNT_DETAILS_ULID_ID = "BBBBBBBBBB";
    ...
    public static CreditAccountDetails createEntity(EntityManager em) {
        CreditAccountDetails creditAccountDetails = new CreditAccountDetails()
            ...
            .creditAccountDetailsUlidId(DEFAULT_CREDIT_ACCOUNT_DETAILS_ULID_ID)
    ...
    public static CreditAccountDetails createUpdatedEntity(EntityManager em) {
        CreditAccountDetails creditAccountDetails = new CreditAccountDetails()
            ...
            .creditAccountDetailsUlidId(UPDATED_CREDIT_ACCOUNT_DETAILS_ULID_ID)
    ...
    void createCreditAccountDetails() throws Exception {
        ...
        assertThat(testCreditAccountDetails.getCreditAccountDetailsUlidId()).isEqualTo(DEFAULT_CREDIT_ACCOUNT_DETAILS_ULID_ID);
        ...
        assertThat(testCreditAccountDetails.getDestinationAccountName()).isEqualTo(DEFAULT_DESTINATION_ACCOUNT_NAME);
        assertThat(testCreditAccountDetails.getDestinationAccountNumber()).isEqualTo(DEFAULT_DESTINATION_ACCOUNT_NUMBER);
    }
    ...
    void getAllCreditAccountDetails() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].creditAccountDetailsUlidId")
            .value(hasItem(DEFAULT_CREDIT_ACCOUNT_DETAILS_ULID_ID))
            .jsonPath("$.[*].tenantId")
    ...
    void getCreditAccountDetails() {
        ...
        webTestClient
            ...
            .jsonPath("$.creditAccountDetailsUlidId")
            .value(is(DEFAULT_CREDIT_ACCOUNT_DETAILS_ULID_ID))
            .jsonPath("$.tenantId")
    ...
    void putExistingCreditAccountDetails() throws Exception {
        ...
        assertThat(testCreditAccountDetails.getCreditAccountDetailsUlidId()).isEqualTo(UPDATED_CREDIT_ACCOUNT_DETAILS_ULID_ID);
        ...
        assertThat(testCreditAccountDetails.getDestinationAccountName()).isEqualTo(UPDATED_DESTINATION_ACCOUNT_NAME);
        assertThat(testCreditAccountDetails.getDestinationAccountNumber()).isEqualTo(UPDATED_DESTINATION_ACCOUNT_NUMBER);
    }
