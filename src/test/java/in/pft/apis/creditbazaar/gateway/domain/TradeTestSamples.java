...
public class TradeTestSamples {
    ...
    public static Trade getTradeSample1() {
        return new Trade()
            .id(1L)
            .tradeUlidId("tradeUlidId1")
            .tradeRefNo("tradeRefNo1")
    ...
    public static Trade getTradeSample2() {
        return new Trade()
            .id(2L)
            .tradeUlidId("tradeUlidId2")
            .tradeRefNo("tradeRefNo2")
    ...
    public static Trade getTradeRandomSampleGenerator() {
        return new Trade()
            ...
            .tradeUlidId(UUID.randomUUID().toString())
            .tradeRefNo(UUID.randomUUID().toString())
