...
class FinanceRequestResourceIT {
    ...
    private static final String DEFAULT_FINANCE_REQUEST_ULID_ID = "AAAAAAAAAA";
    private static final String UPDATED_FINANCE_REQUEST_ULID_ID = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_TRADE_CHANNEL_ID = "AAAAAAAAAA";
    private static final String UPDATED_TRADE_CHANNEL_ID = "BBBBBBBBBB";
    ...
    private static final Boolean DEFAULT_GST_CONSENT = false;
    private static final Boolean UPDATED_GST_CONSENT = true;
    ...
    void createFinanceRequest() throws Exception {
        ...
        assertThat(testFinanceRequest.getFinanceRequestId()).isEqualTo(DEFAULT_FINANCE_REQUEST_ID);
        assertThat(testFinanceRequest.getFinanceRequestUlidId()).isEqualTo(DEFAULT_FINANCE_REQUEST_ULID_ID);
        assertThat(testFinanceRequest.getFinanceRequestRefNo()).isEqualTo(DEFAULT_FINANCE_REQUEST_REF_NO);
        assertThat(testFinanceRequest.getTradeChannelId()).isEqualTo(DEFAULT_TRADE_CHANNEL_ID);
        ...
        assertThat(testFinanceRequest.getGstConsent()).isEqualTo(DEFAULT_GST_CONSENT);
    }
    ...
    void getAllFinanceRequests() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].financeRequestUlidId")
            .value(hasItem(DEFAULT_FINANCE_REQUEST_ULID_ID))
            .jsonPath("$.[*].financeRequestRefNo")
            .value(hasItem(DEFAULT_FINANCE_REQUEST_REF_NO))
            .jsonPath("$.[*].tradeChannelId")
            .value(hasItem(DEFAULT_TRADE_CHANNEL_ID))
            ...
            .jsonPath("$.[*].gstConsent")
            .value(hasItem(DEFAULT_GST_CONSENT.booleanValue()));
    }
    ...
    void getFinanceRequest() {
        ...
        webTestClient
            ...
            .jsonPath("$.financeRequestUlidId")
            .value(is(DEFAULT_FINANCE_REQUEST_ULID_ID))
            .jsonPath("$.financeRequestRefNo")
            .value(is(DEFAULT_FINANCE_REQUEST_REF_NO))
            .jsonPath("$.tradeChannelId")
            .value(is(DEFAULT_TRADE_CHANNEL_ID))
            .jsonPath("$.requestAmount")
            ...
            .jsonPath("$.gstConsent")
            .value(is(DEFAULT_GST_CONSENT.booleanValue()));
    }
    ...
    void putExistingFinanceRequest() throws Exception {
        ...
        FinanceRequest testFinanceRequest = financeRequestList.get(financeRequestList.size() - 1);
        assertThat(testFinanceRequest.getFinanceRequestId()).isEqualTo(UPDATED_FINANCE_REQUEST_ID);
        assertThat(testFinanceRequest.getFinanceRequestUlidId()).isEqualTo(UPDATED_FINANCE_REQUEST_ULID_ID);
        assertThat(testFinanceRequest.getFinanceRequestRefNo()).isEqualTo(UPDATED_FINANCE_REQUEST_REF_NO);
        assertThat(testFinanceRequest.getTradeChannelId()).isEqualTo(UPDATED_TRADE_CHANNEL_ID);
        ...
        assertThat(testFinanceRequest.getGstConsent()).isEqualTo(UPDATED_GST_CONSENT);
    }
