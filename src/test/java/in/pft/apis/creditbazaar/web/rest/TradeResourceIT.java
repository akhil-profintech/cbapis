...
class TradeResourceIT {
    ...
    private static final String DEFAULT_TRADE_REF_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_TRADE_REF_NUMBER = "BBBBBBBBBB";
    ...
    public static Trade createEntity(EntityManager em) {
        Trade trade = new Trade()
            ...
            .tradeRefNumber(DEFAULT_TRADE_REF_NUMBER)
    ...
    public static Trade createUpdatedEntity(EntityManager em) {
        Trade trade = new Trade()
            ...
            .tradeRefNumber(UPDATED_TRADE_REF_NUMBER)
    ...
    void createTrade() throws Exception {
        ...
        assertThat(testTrade.getTradeId()).isEqualTo(DEFAULT_TRADE_ID);
        assertThat(testTrade.getTradeRefNumber()).isEqualTo(DEFAULT_TRADE_REF_NUMBER);
    ...
    void getAllTrades() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].tradeId")
            .value(hasItem(DEFAULT_TRADE_ID.intValue()))
            .jsonPath("$.[*].tradeRefNumber")
            .value(hasItem(DEFAULT_TRADE_REF_NUMBER))
    ...
    void getTrade() {
        ...
        webTestClient
            ...
            .jsonPath("$.tradeId")
            .value(is(DEFAULT_TRADE_ID.intValue()))
            .jsonPath("$.tradeRefNumber")
            .value(is(DEFAULT_TRADE_REF_NUMBER))
            .jsonPath("$.sellerGstId")
    ...
    void putExistingTrade() throws Exception {
        ...
        Trade testTrade = tradeList.get(tradeList.size() - 1);
        assertThat(testTrade.getTradeId()).isEqualTo(UPDATED_TRADE_ID);
        assertThat(testTrade.getTradeRefNumber()).isEqualTo(UPDATED_TRADE_REF_NUMBER);
