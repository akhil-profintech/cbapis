...
class SettlementResourceIT {
    ...
    private static final String DEFAULT_SETTLEMENT_ID = "AAAAAAAAAA";
    private static final String UPDATED_SETTLEMENT_ID = "BBBBBBBBBB";
    ...
    void createSettlement() throws Exception {
        ...
        assertThat(testSettlement.getOfferId()).isEqualTo(DEFAULT_OFFER_ID);
    ...
    void getAllSettlements() {
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_SETTLEMENT_ID))
    ...
    void getSettlement() {
        ...
        webTestClient
            ...
            .jsonPath("$.settlementId")
            .value(is(DEFAULT_SETTLEMENT_ID))
            .jsonPath("$.settlementRefNo")
    ...
    void putExistingSettlement() throws Exception {
        ...
        assertThat(testSettlement.getOfferId()).isEqualTo(UPDATED_OFFER_ID);
