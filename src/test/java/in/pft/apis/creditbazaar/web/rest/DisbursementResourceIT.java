...
import in.pft.apis.creditbazaar.service.DisbursementService;
...
class DisbursementResourceIT {
    ...
    void createDisbursement() throws Exception {
        ...
        assertThat(testDisbursement.getAcceptedOfferId()).isEqualTo(DEFAULT_ACCEPTED_OFFER_ID);
        assertThat(testDisbursement.getOfferId()).isEqualTo(DEFAULT_OFFER_ID);
        ...
        assertThat(testDisbursement.getDbmtstatus()).isEqualTo(DEFAULT_DBMTSTATUS);
        assertThat(testDisbursement.getOfferStatus()).isEqualTo(DEFAULT_OFFER_STATUS);
        assertThat(testDisbursement.getFtTrnxDetailsId()).isEqualTo(DEFAULT_FT_TRNX_DETAILS_ID);
        assertThat(testDisbursement.getCollectionTrnxDetailsId()).isEqualTo(DEFAULT_COLLECTION_TRNX_DETAILS_ID);
        ...
        assertThat(testDisbursement.getIfscCode()).isEqualTo(DEFAULT_IFSC_CODE);
    ...
    void checkAcceptedOfferIdIsRequired() throws Exception {
        ...
        // set the field null
        disbursement.setAcceptedOfferId(null);
    ...
    void putExistingDisbursement() throws Exception {
        ...
        assertThat(testDisbursement.getAcceptedOfferId()).isEqualTo(UPDATED_ACCEPTED_OFFER_ID);
        assertThat(testDisbursement.getOfferId()).isEqualTo(UPDATED_OFFER_ID);
        ...
        assertThat(testDisbursement.getDbmtstatus()).isEqualTo(UPDATED_DBMTSTATUS);
        assertThat(testDisbursement.getOfferStatus()).isEqualTo(UPDATED_OFFER_STATUS);
        assertThat(testDisbursement.getFtTrnxDetailsId()).isEqualTo(UPDATED_FT_TRNX_DETAILS_ID);
        assertThat(testDisbursement.getCollectionTrnxDetailsId()).isEqualTo(UPDATED_COLLECTION_TRNX_DETAILS_ID);
        ...
        assertThat(testDisbursement.getIfscCode()).isEqualTo(UPDATED_IFSC_CODE);
