...
class CreditBazaarIntegratorResourceIT {
    ...
    private static final String DEFAULT_INTEGRATOR_ID = "AAAAAAAAAA";
    private static final String UPDATED_INTEGRATOR_ID = "BBBBBBBBBB";
    ...
    public static CreditBazaarIntegrator createUpdatedEntity(EntityManager em) {
        CreditBazaarIntegrator creditBazaarIntegrator = new CreditBazaarIntegrator()
            ...
            .integratorId(UPDATED_INTEGRATOR_ID)
    ...
    void createCreditBazaarIntegrator() throws Exception {
        ...
        assertThat(testCreditBazaarIntegrator.getIntegratorId()).isEqualTo(DEFAULT_INTEGRATOR_ID);
    ...
    @Test
    void checkIntegratorIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = creditBazaarIntegratorRepository.findAll().collectList().block().size();
        // set the field null
        creditBazaarIntegrator.setIntegratorId(null);
    ...
    void getAllCreditBazaarIntegrators() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].integratorId")
            .value(hasItem(DEFAULT_INTEGRATOR_ID))
            .jsonPath("$.[*].orgId")
    ...
    void getCreditBazaarIntegrator() {
        ...
        webTestClient
            ...
            .jsonPath("$.integratorId")
            .value(is(DEFAULT_INTEGRATOR_ID))
            .jsonPath("$.orgId")
    ...
    void putExistingCreditBazaarIntegrator() throws Exception {
        ...
        assertThat(testCreditBazaarIntegrator.getIntegratorId()).isEqualTo(UPDATED_INTEGRATOR_ID);
