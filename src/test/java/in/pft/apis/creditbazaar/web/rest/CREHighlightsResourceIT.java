...
import in.pft.apis.creditbazaar.repository.CREHighlightsRepository;
import in.pft.apis.creditbazaar.repository.EntityManager;
import in.pft.apis.creditbazaar.service.CREHighlightsService;
import in.pft.apis.creditbazaar.service.dto.CREHighlightsDTO;
import in.pft.apis.creditbazaar.service.mapper.CREHighlightsMapper;
...
class CREHighlightsResourceIT {
    ...
    @Test
    void checkCreHighlightsIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = cREHighlightsRepository.findAll().collectList().block().size();
        // set the field null
        cREHighlights.setCreHighlightsId(null);

        // Create the CREHighlights, which fails.
        CREHighlightsDTO cREHighlightsDTO = cREHighlightsMapper.toDto(cREHighlights);
        ...
        List<CREHighlights> cREHighlightsList = cREHighlightsRepository.findAll().collectList().block();
        assertThat(cREHighlightsList).hasSize(databaseSizeBeforeTest);
    }
    ...
    void putExistingCREHighlights() throws Exception {
        ...
        updatedCREHighlights.creHighlightsId(UPDATED_CRE_HIGHLIGHTS_ID).creRequestId(UPDATED_CRE_REQUEST_ID).highlights(UPDATED_HIGHLIGHTS);
    ...
    void partialUpdateCREHighlightsWithPatch() throws Exception {
        ...
        partialUpdatedCREHighlights.creRequestId(UPDATED_CRE_REQUEST_ID);
