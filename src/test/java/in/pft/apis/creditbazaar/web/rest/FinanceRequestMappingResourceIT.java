...
import in.pft.apis.creditbazaar.repository.FinanceRequestMappingRepository;
import in.pft.apis.creditbazaar.service.dto.FinanceRequestMappingDTO;
import in.pft.apis.creditbazaar.service.mapper.FinanceRequestMappingMapper;
...
class FinanceRequestMappingResourceIT {
    ...
    void partialUpdateFinanceRequestMappingWithPatch() throws Exception {
        ...
        partialUpdatedFinanceRequestMapping.anchorTraderId(UPDATED_ANCHOR_TRADER_ID).financePartnerId(UPDATED_FINANCE_PARTNER_ID);
