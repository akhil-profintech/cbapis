...
import in.pft.apis.creditbazaar.service.mapper.ParticipantSettlementMapper;
...
class ParticipantSettlementResourceIT {
    ...
    private static final String DEFAULT_SETTLEMENT_TYPE = "AAAAAAAAAA";
    private static final String UPDATED_SETTLEMENT_TYPE = "BBBBBBBBBB";
    ...
    @Test
    void checkParticipantSettlementIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = participantSettlementRepository.findAll().collectList().block().size();
        // set the field null
        participantSettlement.setParticipantSettlementId(null);
    ...
    void getAllParticipantSettlements() {
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_SETTLEMENT_TYPE))
    ...
    void getParticipantSettlement() {
        ...
        webTestClient
            ...
            .jsonPath("$.settlementType")
            .value(is(DEFAULT_SETTLEMENT_TYPE))
            .jsonPath("$.settlementAmount")
