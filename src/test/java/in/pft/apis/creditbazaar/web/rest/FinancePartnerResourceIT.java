...
import in.pft.apis.creditbazaar.repository.FinancePartnerRepository;
import in.pft.apis.creditbazaar.service.dto.FinancePartnerDTO;
import in.pft.apis.creditbazaar.service.mapper.FinancePartnerMapper;
...
class FinancePartnerResourceIT {
    ...
    private static final String DEFAULT_FP_ID = "AAAAAAAAAA";
    private static final String UPDATED_FP_ID = "BBBBBBBBBB";
    ...
    @Test
    void checkFpIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = financePartnerRepository.findAll().collectList().block().size();
        // set the field null
        financePartner.setFpId(null);
