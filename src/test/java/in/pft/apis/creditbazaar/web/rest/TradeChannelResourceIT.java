...
import in.pft.apis.creditbazaar.repository.TradeChannelRepository;
import in.pft.apis.creditbazaar.service.dto.TradeChannelDTO;
import in.pft.apis.creditbazaar.service.mapper.TradeChannelMapper;
...
class TradeChannelResourceIT {
    ...
    void createTradeChannel() throws Exception {
        ...
        assertThat(testTradeChannel.getTradeChannelId()).isEqualTo(DEFAULT_TRADE_CHANNEL_ID);
    ...
    void putExistingTradeChannel() throws Exception {
        ...
        TradeChannel testTradeChannel = tradeChannelList.get(tradeChannelList.size() - 1);
        assertThat(testTradeChannel.getTradeChannelId()).isEqualTo(UPDATED_TRADE_CHANNEL_ID);
