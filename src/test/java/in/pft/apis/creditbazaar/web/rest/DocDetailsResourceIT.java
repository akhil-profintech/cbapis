...
import in.pft.apis.creditbazaar.repository.DocDetailsRepository;
import in.pft.apis.creditbazaar.repository.EntityManager;
import in.pft.apis.creditbazaar.service.DocDetailsService;
import in.pft.apis.creditbazaar.service.dto.DocDetailsDTO;
import in.pft.apis.creditbazaar.service.mapper.DocDetailsMapper;
...
class DocDetailsResourceIT {
    ...
    @Test
    void checkDocDetailsIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = docDetailsRepository.findAll().collectList().block().size();
        // set the field null
        docDetails.setDocDetailsId(null);
    ...
    void partialUpdateDocDetailsWithPatch() throws Exception {
        ...
        partialUpdatedDocDetails.docRecordId(UPDATED_DOC_RECORD_ID).docType(UPDATED_DOC_TYPE).status(UPDATED_STATUS);
