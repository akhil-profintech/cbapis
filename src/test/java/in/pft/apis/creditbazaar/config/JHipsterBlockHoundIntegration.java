...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("in.pft.apis.creditbazaar.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("in.pft.apis.creditbazaar.security.DomainUserDetailsService", "createSpringSecurityUser");
